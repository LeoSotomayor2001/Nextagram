    ...
    return (
        <div className="flex justify-center items-center h-screen flex-col">
            ...
            >
                ...
                <span className="text-gray-600 dark:text-gray-400 text-lg mb-6 text-center font-semibold">
            ...
            <div className="p-6 rounded-lg shadow-md w-96 flex flex-col border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 my-5 transition-colors duration-300">
                <Link
                    href="/auth/login"
                    className="text-gray-600 dark:text-gray-400 text-lg text-center font-semibold hover:text-sky-500 dark:hover:text-sky-500 transition-colors"
                >
